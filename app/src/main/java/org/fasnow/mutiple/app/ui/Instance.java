...
import org.fasnow.mutiple.app.model.nacos.Nacos;
import org.fasnow.mutiple.app.model.redis.Redis;
import org.fasnow.mutiple.app.ui.controller.MainController;
import org.fasnow.mutiple.app.ui.controller.NacosController;
import org.fasnow.mutiple.app.ui.controller.RedisController;
...
public class Instance {
    ...
    static {
        ...
        try {
            ...
            scene.getStylesheets().add(Objects.requireNonNull(Instance.class.getResource("/ui/button.css")).toExternalForm());
