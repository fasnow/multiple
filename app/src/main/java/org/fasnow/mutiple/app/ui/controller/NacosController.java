...
import org.fasnow.mutiple.app.model.nacos.Vuls;
                        ...
                        executorService.execute(() -> {
                            try {
                                ...
                                if (method.getParameterCount() == 0) {
                                    ...
                                    result = (Result) method.invoke(nacosInstance, true);
                                }
    ...
    void dumpConfigBtnAction(Event event) {
        ...
        CompletableFuture.supplyAsync(() -> {
            ...
            if(useAuth.isSelected()){
                ...
                try {
                    if(nacosInstance.invalidAuthToken(token)){
                ...
                if(vulCB1.getValue().equals(a.get(0))){
                    ...
                    try {
                        if(nacosInstance.invalidAuthToken(t)){//抛出异常，不用return
